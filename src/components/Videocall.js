                ...
                <div class="row d-flex">
                    <div class="col-12 col-md-8">
                        <div class="bg-image align-items-center w-100 vh-100"
                            ...
                            <div class="position-relative bottom-900">
                                <div class="text-white text-start title btn-green" style={{ alignItems: 'flex-end;', width: '-webkit-fill-available', height: ' 60px;' }}>
